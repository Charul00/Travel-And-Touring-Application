...
public class DeleteCustomer extends JFrame {
	public AbstractButton b1;
	public AbstractButton l4;
	public AbstractButton l8;
	...
	public DeleteCustomer() throws SQLException {
		...
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Conn c = new Conn();
				try {
					// Get selected username dynamically
					String selectedUsername = c1.getSelectedItem();
					// Execute query based on selected username
					...
					if (rs.next()) {
						...
						JOptionPane.showMessageDialog(null, "No customer found with the selected username.");
					}
					rs.close();
				} catch (Exception ee) {
					ee.printStackTrace();
